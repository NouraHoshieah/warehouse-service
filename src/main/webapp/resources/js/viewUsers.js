...
//		                    });
//		                    var warehouseServiceTable = $("<table buser='1' width='100%'>");
...
//		                    });
//		                    var title = $("<span>warehouseService details for the sales user (" + item.salesuser + "):</span>");
...
//		                    
//		                    var $customButton = $("<a>")
//		                    	.html("<span style='padding-left: 5px;' id='" +linkId + "'>View warehouseService (<span class=\"userTotalwarehouseService_" + getRandomNumber() + "\">" + item.warehouseService.length + "</span>)</span>")
//		                    	.click(function(e) {
