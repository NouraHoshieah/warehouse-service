...
//			                    
//		                    var warehouseServiceContent = $("<div>");
//		                    warehouseServiceContent.dialog({
//		                        autoOpen: false, 
//		                        title: "View warehouseService ("+item.warehouseService.length+")",
//		                        width: "500px",
//		                        position: { my: "center", at: "top" }
//		                    });
//		                    var warehouseServiceTable = $("<table brecipe='1' width='100%'>");
//		                    warehouseServiceTable.append($("<tr><th>Index</th><th>Name</th><th>Quantity</th><th>Rate</th><th>Selling Price</th></tr>'"))
//		                    var i = 0;
//		                    $.each(item.warehouseService, function (i, itm) {
//		                    	i++;
//		                    	var nameLbl = "<label id=\"itemDetName_" + getRandomNumber() + "\">" + itm.name + "</label>"
//		                    	
//		                    	warehouseServiceTable.append('<tr><td>'+i+'</td><td>' + nameLbl + '</td><td>' + itm.quantity + 
//		                    			'</td><td>' + itm.rate + '</td><td>' + itm.sellingPrice + '</td></tr>');
//		                    });
//		                    var title = $("<span>warehouseService details for the sales recipe (" + item.salesrecipe + "):</span>");
//		                    warehouseServiceContent.append(title);
//		                    warehouseServiceContent.append(warehouseServiceTable);
//
//		                    var total = $("<span>Total number of warehouseService (<span class=\"dialogDetailsTotalwarehouseService_" + getRandomNumber() + "\">" + item.warehouseService.length + "</span>):</span>");
//		                    warehouseServiceContent.append(total);
//		                    
//		                    var $customButton = $("<a>")
//		                    	.html("<span style='padding-left: 5px;' id='" +linkId + "'>View warehouseService (<span class=\"recipeTotalwarehouseService_" + getRandomNumber() + "\">" + item.warehouseService.length + "</span>)</span>")
//		                    	.click(function(e) {
//		                    		warehouseServiceContent.dialog( "open" );
//		                            e.stopPropagation();
//		                        });
